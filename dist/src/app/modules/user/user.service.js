...
export class UserService {
    ...
    static async getAllUsers(page = 1, limit = 10, search, role, status) {
    ...
    static async getUserStats() {
        ...
        const [totalUsers, activeUsers, adminCount, managerCount, userCount, newThisMonth, newThisWeek, verifiedUsers] = await Promise.all([
            prisma.user.count(),
