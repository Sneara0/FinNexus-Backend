...
export class AdminService {
    ...
    static async getDashboardStats() {
        ...
        const [totalUsers, activeUsers, totalTransactions, totalIncome, totalExpense, totalBudgets, totalGoals, completedGoals, newUsersThisMonth, newUsersThisWeek, recentTransactions] = await Promise.all([
            prisma.user.count(),
    ...
    // ========================================
    static async getAllUsers(page = 1, limit = 10, search = "", role = "all", status = "all") {
