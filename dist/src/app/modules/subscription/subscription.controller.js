...
// ========================================
export const reactivateSubscription = catchAsync(async (req, res) => {
    const userId = req.user?.id;
    const { id } = req.params;
    const subscription = await SubscriptionService.reactivateSubscription(id, userId);
...
// ========================================
export const getSubscriptionSummary = catchAsync(async (req, res) => {
    const userId = req.user?.id;
...
// ========================================
export const processRenewals = catchAsync(async (req, res) => {
...
// ========================================
export const sendReminders = catchAsync(async (req, res) => {
    if (req.user?.role !== 'ADMIN') {
        return sendError(res, 'শুধু অ্যাডমিন এই কাজ করতে পারেন', 403);
    }
