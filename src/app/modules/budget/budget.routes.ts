...
router.get(
  '/',
  validateRequest(BudgetValidation.budgetListSchema),
...
router.get(
  '/:id',
  validateRequest(BudgetValidation.budgetIdParamSchema),
...
router.post(
  '/create-budget',
  validateRequest(BudgetValidation.createBudgetSchema),
...
router.patch(
  '/:id',
  validateRequest(BudgetValidation.updateBudgetSchema),
